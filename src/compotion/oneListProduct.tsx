                    ...
                    <div className="row">
                        ...
                        <div className="col-sm-6 col-lg-3">
                            <div className="card px-5 py-3 bg-dark-subtle" style={{ width: '18rem', height: '14rem' }}>
                                ...
                                <a href="">
                                    <img src="https://footdealer.co/wp-content/uploads/2023/06/Maillot-Manchester-United-Domicile-2023-2024-1.jpg" className="card-img-top" style={{ width: '11rem' }} alt="Product" />
                                </a>
                            </div>
                            <div className="card-body mt-3">
                                <h5 className="card-title">aaaaaaaaaaaaaa</h5>
                                <div className="prices my-3">
                                    <span className="price-old text-danger fw-medium">$1000</span>
                                    <span className="sep">-</span>
                                    <span className="price text-decoration-line-through fw-medium">$10000</span>
                                </div>
                            </div>
                            <div className="start">
