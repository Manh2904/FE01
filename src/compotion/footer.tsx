              ...
              <div className="widget-item">
                <div className="about-widget-wrap">
                  ...
                  <div className="social-icons">
                    <a href="https://www.facebook.com/" target="_blank" rel="noopener"><i className="bi bi-facebook"></i></a>
                    <a href="https://dribbble.com/" target="_blank" rel="noopener"><i className="bi bi-dribbble"></i></a>
                    <a href="https://www.pinterest.com/" target="_blank" rel="noopener"><i className="bi bi-pinterest"></i></a>
                    <a href="https://twitter.com/" target="_blank" rel="noopener"><i className="bi bi-twitter"></i></a>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container pt--0 pb--0">
          <div className="row">
            <div className="col-md-12 col-lg-12 text-center ">
              <p className="copyright">© from<i className="fa fa-heart"></i> by <a target="_blank" href="">Code</a></p>
            </div>
          </div>
        </div>
      </div>
